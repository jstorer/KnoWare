...
final public class SwiftColorPickerViewController: UIViewController
{
    ...
    ///
    /// Default is 10
    public var coloredBorderWidth:Int = 5 {
        didSet {
    ...
    public var colorPreviewDiameter:Int = 80 {
        didSet {
    ...
    public var numberColorsInXDirection: Int = 50 {
        didSet {
    ...
    ///
    /// Color palette size is `numberColorsInXDirection * numberColorsInYDirection`
    public var numberColorsInYDirection: Int = 58 {
        didSet {
    ...
    fileprivate func setConstraintsForColorPreView()
    {
        ...
        let constH2 = NSLayoutConstraint.constraints(withVisualFormat: "H:|-pad-[selectionView(diameter)]", options: NSLayoutFormatOptions(), metrics: metrics, views: views)
        ...
        let constV2 = NSLayoutConstraint.constraints(withVisualFormat: "V:|-pad-[selectionView(diameter)]", options: NSLayoutFormatOptions(), metrics: metrics, views: views)
